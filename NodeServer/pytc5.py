...
for i in prioritizelist:
    slowstring="tc filter add dev "+interface+" parent 1: protocol ip prio 2 u32 match ip dst "+i+" flowid 1:10"
    os.system(slowstring)
    print slowstring

for i in slowlist:
    slowstring="tc filter add dev "+interface+" parent 1: protocol ip prio 2 u32 match ip dst "+i+" flowid 1:30"
    os.system(slowstring)
    print slowstring
